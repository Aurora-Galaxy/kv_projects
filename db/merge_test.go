...
func TestDB_Merge2(t *testing.T) {
	opts := conf.DefaultOptions
	dir := filepath.Join("./temp", "bitcask-go-merge-2")
...
func TestDB_Merge3(t *testing.T) {
	opts := conf.DefaultOptions
	dir := filepath.Join("./temp", "bitcask-go-merge-3")
	opts.DataFileSize = 32 * 1024 * 1024
	opts.DataFileMergeRatio = 0
	opts.DirPath = dir
	db, err := Open(opts)
...
func TestDB_Merge4(t *testing.T) {
	opts := conf.DefaultOptions
	dir := filepath.Join("./temp", "bitcask-go-merge-4")
	opts.DataFileSize = 32 * 1024 * 1024
	opts.DataFileMergeRatio = 0
	opts.DirPath = dir
	db, err := Open(opts)
...
func TestDB_Merge5(t *testing.T) {
	opts := conf.DefaultOptions
	dir := filepath.Join("./temp", "bitcask-go-merge-5")
	opts.DataFileSize = 32 * 1024 * 1024
	opts.DataFileMergeRatio = 0
	opts.DirPath = dir
	db, err := Open(opts)
